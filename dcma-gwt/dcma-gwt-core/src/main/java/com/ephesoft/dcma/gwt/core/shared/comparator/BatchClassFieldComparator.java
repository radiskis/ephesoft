...
/**
 * @author Ephesoft Compares two BatchClassFieldDTOs based on property defined in order object
 */
public class BatchClassFieldComparator implements Comparator<Object> {
	...
	public Object getProperty(final DomainProperty domainProperty, final BatchClassFieldDTO batchClassFieldDTO) {
		Object propObj = null;
		if (domainProperty.getProperty().equals(BatchClassFieldProperty.NAME.getProperty())) {
			propObj = batchClassFieldDTO.getName();
		} else if (domainProperty.getProperty().equals(BatchClassFieldProperty.FIELDORDERNUMBER.getProperty())) {
			propObj = batchClassFieldDTO.getFieldOrderNumber();
		} else if (domainProperty.getProperty().equals(BatchClassFieldProperty.DESCRIPTION.getProperty())) {
