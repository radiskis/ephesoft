...
public class RemoteBatchInstanceDTO implements IsSerializable {

	/**
	 * Initializing remote url.
	 */
	private String remoteURL;

	/**
	 * Initializing remote batch instance identifier.
	 */
	private String remoteBatchInstanceIdentifier;

	/**
	 * Initializing previous remote url.
	 */
	private String previousRemoteURL;

	/**
	 * Initializing previous remote batch instance identifier.
	 */
	private String previousRemoteBatchInstanceIdentifier;

	/**
	 * Initializing source module.
	 */
