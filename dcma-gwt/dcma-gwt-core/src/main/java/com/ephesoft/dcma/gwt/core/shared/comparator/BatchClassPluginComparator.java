...
public class BatchClassPluginComparator implements Comparator<Object> {
	...
	public int compare(final Object pluginDTOOne, final Object pluginDTOTwo) {
		...
		final BatchClassPluginDTO batchClassPluginDTOOne = (BatchClassPluginDTO) pluginDTOOne;
	 ...
	 * @return
	 */
	public String getProperty(final DomainProperty domainProperty, final BatchClassPluginDTO pluginDetailsDTO) {
		String property = null;
		if (domainProperty.getProperty().equals(PluginProperty.NAME.getProperty())) {
			property = pluginDetailsDTO.getPlugin().getPluginName();
		} else if (domainProperty.getProperty().equals(PluginProperty.DESCRIPTION.getProperty())) {
			property = pluginDetailsDTO.getPlugin().getPluginDescription();
		} else if (domainProperty.getProperty().equals(PluginProperty.ORDER.getProperty())) {
			property = String.valueOf(pluginDetailsDTO.getOrderNumber());
		}
