 ...
 */
public class KVExtractionTestResultViewPresenter extends AbstractBatchClassPresenter<KVExtractionTestResultView> {

	/**
	 * Constructor.
	 * 
	 * @param controller BatchClassManagementController
	 * @param view KVExtractionTestResultView
	 */
	public KVExtractionTestResultViewPresenter(final BatchClassManagementController controller, final KVExtractionTestResultView view) {
