...
public class EditModulePresenter extends AbstractBatchClassPresenter<EditModuleView> {
	...
	public void onSave() {
		...
		if ((remoteURL != null && remoteBCId != null)
				&& ((remoteURL.isEmpty() && remoteBCId.isEmpty()) || (!remoteBCId.isEmpty() && !remoteURL.isEmpty()))) {
			controller.getSelectedModule().setRemoteURL(remoteURL);
			controller.getSelectedModule().setRemoteBatchClassIdentifier(remoteBCId);
			controller.getMainPresenter().getModuleViewPresenter().getModuleDetailPresenter().bind();
			controller.getMainPresenter().getModuleViewPresenter().showModuleDetailView();
		} else {
