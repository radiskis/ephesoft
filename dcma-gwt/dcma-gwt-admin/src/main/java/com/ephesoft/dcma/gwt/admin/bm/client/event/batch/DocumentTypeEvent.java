...
public class DocumentTypeEvent extends GwtEvent<DocumentTypeHandler> {
	...
	/**
	 * The document that the user is working on.
	 */
	...
	@Override
	protected void dispatch(final DocumentTypeHandler handler) {
		switch (action) {
			case EDIT:
				handler.onDocumentTypeEdit(this);
				break;
			case SELECT:
				handler.onDocumentTypeSelect(this);
			default:
				break;
		}
	}
