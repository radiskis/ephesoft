 ...
 */
public class TableTestResultViewPresenter extends AbstractBatchClassPresenter<TableTestResultView> {

	/**
	 * Constructor.
	 * 
	 * @param controller BatchClassManagementController
	 * @param view TableTestResultView
	 */
	public TableTestResultViewPresenter(final BatchClassManagementController controller, final TableTestResultView view) {
