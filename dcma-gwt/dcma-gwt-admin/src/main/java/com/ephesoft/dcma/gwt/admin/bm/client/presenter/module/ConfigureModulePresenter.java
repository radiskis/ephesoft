...
public class ConfigureModulePresenter extends AbstractBatchClassPresenter<ConfigureModuleView> {
	...
	private void populateAndShowAddModuleView() {
	...
	/**
	 * @param batchClassModuleDTOs
	 */
	public void setBatchClassDTOModulesList(final List<String> modulesList) {
		...
		controller.getRpcService().setBatchClassDTOModulesList(controller.getBatchClass(), modulesList,
				new AsyncCallback<BatchClassDTO>() {
					...
					public void onFailure(Throwable arg0) {
						ConfirmationDialogUtil.showConfirmationDialogError(MessageConstants.ERROR_OCCURED_WHILE_SAVING_MODULES);
						ScreenMaskUtility.unmaskScreen();
					}
				});
