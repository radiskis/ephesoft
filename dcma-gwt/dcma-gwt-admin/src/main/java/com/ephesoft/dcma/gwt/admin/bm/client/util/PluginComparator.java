...
/**
 * @author Ephesoft
 * Compares two BatchClassPluginDTOs based on property defined in order object
 */
public class PluginComparator implements Comparator<Object>, AdminConstants {
	...
	public int compare(final Object pluginDTOOne, final Object pluginDTOTwo) {
		...
		final PluginDetailsDTO pluginDetailsDTOOne = batchClassPluginDTOOne.getPlugin();
		final PluginDetailsDTO pluginDetailsDTOTwo = batchClassPluginDTOTwo.getPlugin();
	...
	public String getProperty(final DomainProperty domainProperty, final PluginDetailsDTO pluginDetailsDTO) {
		...
		if (domainProperty.getProperty().equals(PLUGIN_NAME)) {
			property = pluginDetailsDTO.getPluginName();
		} else {
			if (domainProperty.getProperty().equals(PLUGIN_DESCRIPTION)) {
