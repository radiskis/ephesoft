...
/**
 * @author Ephesoft 
 * Compares two BatchClassModuleDTOs based on property defined in order object
 */
public class ModuleComparator implements Comparator<Object>, AdminConstants {
	...
	public String getProperty(final DomainProperty domainProperty, final BatchClassModuleDTO batchClassModuleDTO) {
		...
		if (domainProperty.getProperty().equals(MODULE_NAME)) {
			property = batchClassModuleDTO.getModule().getName();
		} else if (domainProperty.getProperty().equals(MODULE_DESCRIPTION)) {
