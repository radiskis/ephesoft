...
public class ReportingView extends View<ReportingPresenter> {
	...
	public ReportingView() {
		...
		completeInfo.setText(ReportingConstants.SYSTEM_STATISTICS_LABEL);
		...
		totalBatchesLabel.setText(ReportingConstants.TOTAL_BATCHES_PROCESSED_LABEL);
		...
		totalDocumentsLabel.setText(ReportingConstants.TOTAL_DOCUMENTS_PROCESSED_LABEL);
		totalDocumentsLabel.addStyleName(ReportingConstants.BOLD_TEXT_CSS);

		totalPagesLabel.setText(ReportingConstants.TOTAL_PAGES_PROCESSED);
		totalPagesLabel.addStyleName(ReportingConstants.BOLD_TEXT_CSS);

		syncButton.setText(ReportingConstants.SYNC_DB_BUTTON_TEXT);
		...
		goButton.setText(ReportingConstants.GO_BUTTON_TEXT);
	...
	public void populateIntervalListBox() {
		intervalListBox.addItem(ReportingConstants.INTERVAL_LISTBOX_TEXT_SECONDS, ReportingConstants.INTERVAL_LISTBOX_VALUE_SECONDS);
		intervalListBox.addItem(ReportingConstants.INTERVAL_LISTBOX_TEXT_MINUTES, ReportingConstants.INTERVAL_LISTBOX_VALUE_MINUTES);
		intervalListBox.addItem(ReportingConstants.INTERVAL_LISTBOX_TEXT_HOURS, ReportingConstants.INTERVAL_LISTBOX_VALUE_HOURS);
	}
