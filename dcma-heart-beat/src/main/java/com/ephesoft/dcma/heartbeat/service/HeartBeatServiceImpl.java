...
package com.ephesoft.dcma.heartbeat.service;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.beans.factory.annotation.Autowired;

import com.ephesoft.dcma.heartbeat.HeartBeat;
 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.heartbeat.HeartBeat
 */
public class HeartBeatServiceImpl implements HeartBeatService {
	...
	/**
	 * This method will be call regularly to check the health of the registered servers.
	 */
	@Override
	public void heartBeatHealth() {

		LOGGER.info("**********  Start execution of HeartBeat service.");

		heartBeat.heartBeatHealth();

		LOGGER.info("**********  End execution of HeartBeat service.");
