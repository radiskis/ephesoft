 ...
 * 
 */
@ContextConfiguration(locations = {"classpath:META-INF/applicationContext-heart-beat.xml" })
@Module("dcma-heart-beat")
public abstract class AbstractHeartBeatTest extends DcmaTestCase {

	protected AbstractHeartBeatTest() {
		super();
	}
