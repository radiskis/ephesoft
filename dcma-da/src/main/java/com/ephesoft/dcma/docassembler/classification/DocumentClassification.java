...
/**
 * This class does the actual processing of document assembly. It will read
 * all the pages of the document type Unknown and then create new documents for
 * all these pages found.
 * 
 * @author Ephesoft
 * @version 1.0
