...
/**
 * This service provides API for exporting zipped file for a batch.
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.docushare.service.DocushareExportServiceImpl
 *
 */
public interface DocushareExportService {
	 ...
	 */
	void exportDocushareFiles(final BatchInstanceID batchInstanceID, final String pluginWorkflow) throws DCMAException;
