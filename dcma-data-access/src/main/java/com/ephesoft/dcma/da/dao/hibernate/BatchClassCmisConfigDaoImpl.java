 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.da.dao.BatchClassCmisConfigDao
 */
@Repository
public class BatchClassCmisConfigDaoImpl extends HibernateDao<BatchClassCmisConfiguration> implements BatchClassCmisConfigDao {

	/**
	 * Initializing BATCH_CLASS_IDENTIFIER, string constant.
	 */
	private static final String BATCH_CLASS_IDENTIFIER = "batchClass.identifier";
	
	/**
	 * Initializing BATCH_CLASS, string constant.
	 */
	private static final String BATCH_CLASS = "batchClass";
	
	/**
	 * Initializing IS_DELETED, string constant.
	 */
