 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.da.service.ManualStepHistoryServiceImpl
 */
public interface ManualStepHistoryService {
	 ...
	 * @param userName String
	 */
	void updateEndTimeAndCalculateDuration(String batchInstanceId,String batchInstanceStatus,String userName);
}
