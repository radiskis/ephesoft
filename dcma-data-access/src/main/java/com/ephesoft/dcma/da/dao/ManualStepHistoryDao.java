 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.da.dao.hibernate.ManualStepHistoryDaoImpl
 */
public interface ManualStepHistoryDao extends CacheableDao<ManualStepHistoryInWorkflow> {

	/**
	 * An API to insert the ManualStepHistoryInWorkflow object.
	 * 
	 * @param ManualStepHistoryInWorkflow manualStepHistoryInWorkflow
	 */
	void updateManualStepHistory(ManualStepHistoryInWorkflow manualStepHistoryInWorkflow);
	 ...
	 */
	ManualStepHistoryInWorkflow getManualStepHistory(String batchInstanceId, String batchInstanceStatus, String userName);
	 ...
	 * @return ManualStepHistoryInWorkflow 
	 */
	ManualStepHistoryInWorkflow getExistingManualStepHistory(String batchInstanceId, String batchInstanceStatus, String userName);
