 ...
 * 
 */
@ContextConfiguration(locations = {"classpath:META-INF/applicationContext-export.xml" })
@Module("dcma-export")
public abstract class AbstractExportTest extends DcmaTestCase {

	protected AbstractExportTest() {
		super();
	}
}
