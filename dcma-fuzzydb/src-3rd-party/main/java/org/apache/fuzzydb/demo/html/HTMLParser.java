...
public class HTMLParser implements HTMLParserConstants {
	...
	public static int SUMMARY_LENGTH = 400;
	...
	public String getSummary() throws IOException, InterruptedException {
		...
		// String tit = getTitle();
		/*
		 * if (sum.startsWith(tit) || sum.equals("")) return tit; else
		 */
		return sum;
	}
				...
				case ArgEquals:
					...
					switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
						...
						case ArgQuote2:
							...
							if (inMetaTag && (t1.image.equalsIgnoreCase("content") || t1.image.equalsIgnoreCase("value"))
									&& t2 != null) {
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] {0x2c7e, 0x2c7e, 0x10000, 0x380000, 0x20000, 0x80000, 0x100000, 0x200000, 0x3b0000, 0x3b0000, 0x8000000,
	...
	static private final class LookaheadSuccess extends java.lang.Error {
		...
		private static final long serialVersionUID = 4493356605015908843L;
	}
