...
import com.ephesoft.dcma.webservice.EphesoftWebServiceAPI;

/**
 * This is constants class for web service.
 * 
 * @author Ephesoft
 * @version 1.0
 */
public class WebserviceConstants {
	...
	/**
	 * integer constant for one.
	 */
	public static int ONE = 1;
	
	/**
	 * integer constant for two.
	 */
