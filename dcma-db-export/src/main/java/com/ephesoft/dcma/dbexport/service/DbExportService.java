 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.dbexport.service.DbExportServiceImpl
 */
public interface DbExportService {
         ...
         */
        void dbExport(final BatchInstanceID batchInstanceID, final String pluginWorkflow) throws DCMAException;
}
