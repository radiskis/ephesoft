 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.regex.service.ExtractionServiceImpl
 */
public interface ExtractionService {
	 ...
	 */
	void extractDocumentFields(final BatchInstanceID batchInstanceID, final String pluginWorkflow) throws DCMAException;
	 ...
	 */
	List<DocField> extractDocumentFieldsFromHOCR(String batchClassID, String docTypeName, HocrPages hocrPages)
			throws DCMAException;
