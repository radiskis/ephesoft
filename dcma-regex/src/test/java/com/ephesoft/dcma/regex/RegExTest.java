...
/**
 * This is Junit test for BatchSchemaService. It contains two test cases, first is positive where HOCR xml file is provided second is
 * negative where HOCR xml file is not provied.
 * 
 * @author Ephesoft
 * @see com.ephesoft.dcma.regex.AbstractRegExTest
 * 
 */
public class RegExTest extends AbstractRegExTest {

	/**
	 * String constants.
	 */
	private static final String PROP_FILE_REG_EXP_TEST = "test.properties";
	/**
	 * String constants.
	 */
	...
	/**
	 * Instance of ExtractionService.
	 */
	@Autowired
	private ExtractionService regExpService;
	/**
	...
	/**
	 * Tests the Regular Expression service.
	 */
	@Test
	public void testExtractDocumentFieldsSuccess() {
		boolean result = false;
		...
		try {
			...
			regExpService.extractDocumentFields(new BatchInstanceID(batchInstanceIdSuccess), null);
	...
	/**
	 * Tests the Regular Expression service where HOCR xml file is not present.
	 */
	@Test
	public void testExtractDocumentFieldsFailure() {
		boolean result = true;
		boolean created = false;
		BatchClass initialBatchClass = new BatchClass();
		try {
			...
			regExpService.extractDocumentFields(new BatchInstanceID(batchInstanceIdFailure), null);
