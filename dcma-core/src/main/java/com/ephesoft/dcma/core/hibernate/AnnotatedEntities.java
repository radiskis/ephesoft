...
public class AnnotatedEntities implements ApplicationContextAware {
	...
	public Collection<Class<?>> getEntities() throws Exception {
		Collection<EntityFactoryBean> entityListColl = ApplicationContextUtil.getBeansOfType(applicationContext, EntityFactoryBean.class);
		entities = new LinkedHashSet<Class<?>>();
