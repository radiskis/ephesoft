 ...
 * 
 */
@ContextConfiguration(locations = { "classpath:META-INF/applicationContext-cleanup.xml" })
@Module("dcma-cleanup")
public abstract class AbstractCleanupTest extends DcmaTestCase {

	protected AbstractCleanupTest() {
		super();
	}
