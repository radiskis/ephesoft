 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.ibm.cm.service.IBMCMServiceImpl
 */
public interface IBMCMService {
	 ...
	 */
	void ibmCMExport(final BatchInstanceID batchInstanceID, final String pluginWorkflow) throws DCMAException;
}
