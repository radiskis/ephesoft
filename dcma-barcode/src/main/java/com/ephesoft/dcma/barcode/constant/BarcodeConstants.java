...
package com.ephesoft.dcma.barcode.constant;

/**
 * This class contains all the constants required for this plugin.
 * 
 * @author Ephesoft
 * @version 1.0
 *
...
public class BarcodeConstants {
	...
	/**
	 * The barcode field suffix.
	 */
	public static final int BARCODE_FIELD_SUFFIX = 1;
