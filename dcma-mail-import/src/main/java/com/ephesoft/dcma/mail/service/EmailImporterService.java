...
/**
 * This service provides APIs for processing mailboxes configured for batch class and downloading emails.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.mail.service.EmailImporterServiceImpl
 * 
 */
public interface EmailImporterService {
	 ...
	 * 
	 * @param cm - Custom Message Object
	 * @param folderPath - Folder path under which mail would be stored
	 * @return
