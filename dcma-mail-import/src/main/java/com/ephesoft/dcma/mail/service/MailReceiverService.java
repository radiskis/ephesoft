...
/**
 * This service provides API to read mails for particular configuration.
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.mail.service.MailReceiverServiceImpl
 *
 */
public interface MailReceiverService {

	/**
	 * This method is used to read emails for given configuration.
	 * @param configuration {@link BatchClassEmailConfiguration}
	 * @return {@link List}<{@link CustomMessage}>
