...
package com.ephesoft.dcma.tesseract.constant;

/**
 * This is a common constants file for Tesseract plugin.
 * 
 * @author Ephesoft
 * @version 1.0
 */
public class TesseractConstants {
	...
	/**
	 * Constant for GREATER_THAN_SIGN.
	 */
	public static final String GREATER_THAN_SIGN = ">";
	
	/**
	 * Constant for SEMI_COLON.
	 */
	public static final String SEMI_COLON = ";";
	
	/**
	 * TESSERACT_HOCR_PLUGIN String.
	 */
