...
@ContextConfiguration(locations = {"classpath:META-INF/applicationContext-scripting-plugin.xml"})
@Module("dcma-scripting-plugin")
public abstract class AbstractScriptTest extends DcmaTestCase {
