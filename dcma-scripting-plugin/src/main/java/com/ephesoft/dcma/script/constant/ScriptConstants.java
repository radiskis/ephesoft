...
package com.ephesoft.dcma.script.constant;

/**
 * This is a common constants file for Script extraction plug-in.
 * 
 * @author Ephesoft
 * @version 1.0
 */
public interface ScriptConstants {
	...
	/**
	 * String constant for search coordinates.
	 */
	String SEARCH_COORDINATE = "title=\"bbox";

	/**
	 * String constant for confidence score.
	 */
