...
public interface IUtilCommonConstants {
	...
	String NEW_FILE_FILENAME_SEPERATOR = "newFileFileNameSeperator";
	String MULIPAGE_FILENAME_SEPERATOR = "multiPageFileNameSeperator";
	...
	String HOCR_FILENAME_SEPERATOR = "hocrFileNameSeperator";
	String OCR_INPUT_FILENAME_FORMAT = "ocrInputFileNameFormat";
	String OCR_INPUT_FILENAME_SEPERATOR = "ocrInputFileNameSeperator";
	...
	String THUMBNAIL_FILENAME_SEPERATOR = "thumbNailFileNameSeperator";
	String OVERLAY_FILENAME_SEPERATOR = "overlayFileNameSeperator";
