...
public class BatchClassPluginPropertiesDao implements PluginPropertiesDao {
	...
	public BatchPluginPropertyContainer getPluginProperties(String batchClassIdentifier) {
		...
		List<BatchClassDynamicPluginConfig> batchClassDynamicPluginConfigs = batchClassDynamicPluginConfigDao.getAllDynamicPluginPropertiesForBatchClass(batchClassIdentifier);
		BatchPluginPropertyContainer container = new BatchPluginPropertyContainer(String.valueOf(batchClassIdentifier));
