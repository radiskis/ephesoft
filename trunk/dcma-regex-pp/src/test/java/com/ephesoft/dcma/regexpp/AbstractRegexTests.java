...
@ContextConfiguration(locations = {"classpath:META-INF/applicationContext-regex-pp.xml" })
@Module("dcma-regex-pp")
public abstract class AbstractRegexTests extends DcmaTestCase {

	protected AbstractRegexTests() {
		super();
	}
}
