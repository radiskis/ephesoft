 ...
 *  ie. 100 if key and value is found and 0 if not found.
 * @author Ephesoft
 * @version 1.0
...
public interface RegexService {
	/**
	 * This method extracts the Key values pattern, co-ordinates and confidence for each image file 
	 * and updates the batch.xml for those images respectively.
	 ...
	 */
	void regexPPReader(final BatchInstanceID batchInstanceID, final String pluginWorkflow) throws DCMAException;
}
