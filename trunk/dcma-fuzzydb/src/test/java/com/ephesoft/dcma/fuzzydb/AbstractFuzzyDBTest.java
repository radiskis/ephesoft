 ...
 * 
 */
@ContextConfiguration(locations = {"classpath:META-INF/applicationContext-fuzzydb.xml" })
@Module("dcma-fuzzydb")
public abstract class AbstractFuzzyDBTest extends DcmaTestCase {

	protected AbstractFuzzyDBTest() {
		super();
	}
