...
public class SearchFiles {
  ...
  public static Map<String, Float> generateConfidence(String indexFolder, String query, String field, int noOfPages) throws Exception {
   ...
   * 
   */
  public static ScoreDoc[] doPagingSearch(Searcher searcher, Query query, 
                                     int noOfPages) throws IOException {
