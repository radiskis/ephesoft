...
/**
 * This service is responsible for watching batch class specific folders. It will insert a new batch instance record in the database
 * for the each batch folder that is input to the public unc folder of the batch class.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.monitor.service.FolderMonitorServiceImpl
 * 
 */
public interface FolderMonitorService extends SmartLifecycle {
	...
	/**
	 * API to remove watch on the batch class given it's BatchClassID.
	 * @param batchClassID {@link BatchClassID}
	 */
