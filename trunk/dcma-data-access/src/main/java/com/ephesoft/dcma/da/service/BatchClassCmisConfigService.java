 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.da.service.BatchClassCmisConfigServiceImpl
 */
public interface BatchClassCmisConfigService {
	 ...
	 * 
	 * @param cmisConfigId int
	 * @return {@link BatchClassCmisConfiguration}
	 */
	BatchClassCmisConfiguration getCmisConfigById(int cmisConfigId);

	/**
	 * An API to insert a new Cmis Config object.
	 * 
	 * @param cmisConfiguration {@link BatchClassCmisConfiguration}
	 */
	void insertCmisConfiguration(BatchClassCmisConfiguration cmisConfiguration);
	 ...
	 * @param cmisConfiguration {@link BatchClassCmisConfiguration}
	 */
	void updateCmisConfiguration(BatchClassCmisConfiguration cmisConfiguration);
	 ...
	 * @param cmisConfiguration {@link BatchClassCmisConfiguration}
	 */
	void removeCmisConfiguration(BatchClassCmisConfiguration cmisConfiguration);
}
