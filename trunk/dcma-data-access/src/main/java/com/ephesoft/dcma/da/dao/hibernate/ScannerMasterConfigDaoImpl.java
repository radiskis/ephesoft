...
/**
 * Implementation of a Dao representing Scanner_Master_Config table in database.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.da.dao.ScannerMasterConfigDao
 */
@Repository
public class ScannerMasterConfigDaoImpl extends HibernateDao<ScannerMasterConfiguration> implements ScannerMasterConfigDao {

	/**
	 * LOG to print the logging information.
	 */
	private static final Logger LOG = LoggerFactory.getLogger(ScannerMasterConfigDaoImpl.class);
