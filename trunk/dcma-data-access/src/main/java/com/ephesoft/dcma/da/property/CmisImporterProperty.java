...
/**
 * Enum to specify cmis importer property.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.core.common.DomainProperty
 */
public enum CmisImporterProperty implements DomainProperty {
	 ...
	 */
	CmisImporterProperty(String property) {
