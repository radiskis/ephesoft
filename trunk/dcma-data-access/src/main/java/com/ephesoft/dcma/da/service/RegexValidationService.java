...
/**
 * This is a database service to read data required by Regex Validation Service .
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.da.service.RegexValidationServiceImpl
 */
public interface RegexValidationService {
	 ...
	 * @return List<{@link RegexValidation}>
	 */
	 ...
	 * @param RegexValidation {@link RegexValidation}
	 */
	void removeRegexValidation(RegexValidation RegexValidation);
