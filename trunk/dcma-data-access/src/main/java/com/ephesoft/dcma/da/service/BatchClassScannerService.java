 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.da.service.BatchClassScannerServiceImpl
 */
public interface BatchClassScannerService {
	 ...
	 */
	Map<String, String> getProfileProperties(String profileId);
}
