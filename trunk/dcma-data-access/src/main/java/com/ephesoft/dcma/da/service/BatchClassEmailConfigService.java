...
public interface BatchClassEmailConfigService {
	 ...
	 * @return List<BatchClassEmailConfiguration>
	 */
	List<BatchClassEmailConfiguration> getEmailConfigByBatchClassIdentifier(final String batchClassIdentifier, final int firstIndex,
	 ...
	 * 
	 * @param emailConfiguration BatchClassEmailConfiguration
	 */
	 ...
	 * @param emailConfiguration BatchClassEmailConfiguration
	 */
	void removeEmailConfiguration(BatchClassEmailConfiguration emailConfiguration);
}
