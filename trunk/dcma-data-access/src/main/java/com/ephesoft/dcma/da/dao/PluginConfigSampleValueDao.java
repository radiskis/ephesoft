 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.da.dao.hibernate.PluginConfigSampleValueDaoImpl
 */
public interface PluginConfigSampleValueDao extends CacheableDao<PluginConfigSampleValue> {
