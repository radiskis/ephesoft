 ...
 * 
 */
@ContextConfiguration(locations = {"classpath:META-INF/applicationContext-imagemagick.xml" })
@Module("dcma-imagemagick")
public abstract class AbstractImageMagickTests extends DcmaTestCase {

	protected AbstractImageMagickTests() {
		super();
	}
