...
public class SampleConfidenceBean implements Comparable<SampleConfidenceBean> {
	/**
	 * The sample page name.
	 */
	private String samplePageName;
	/**
	 * Confidence score associated with this sample page.
	 */
	...
	public String toString() {
		return "samplePageName=" + samplePageName + " confidence=" + confidence;
	}
	...
	public int compareTo(SampleConfidenceBean compareToBean) {
		int returnValue = 0;
		if (confidence > compareToBean.confidence){
			returnValue =  -1;
		}
		if (confidence < compareToBean.confidence){
			returnValue =  1;
