...
public class EphesoftCriteria extends DetachedCriteria {
	...
	private BidiMap aliasEntityMap = new TreeBidiMap();
	...
	public String getAlias(String associationPath, boolean containsProperty) {
		...
		String alias = (String) this.aliasEntityMap
				.getKey(involvedEntitiyVars[involvedEntitiyVars.length - (containsProperty ? 2 : 1)]);
