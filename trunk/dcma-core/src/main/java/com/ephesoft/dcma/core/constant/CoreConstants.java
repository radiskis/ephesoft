...
/**
 * This is class for core constants.
 *
 * @author Ephesoft
 * @version 1.0
 *
...
public class CoreConstants {
	...
	/**
	 * integer constant for buffer bytes.
	 */
	public static final int BUFFER_BYTES = 1024;

	/**
	 * integer constant for Thread Sleep Time.
	 */
	public static final int THREAD_SLEEP_TIME = 500;

	/**
	 * String constant for hyphens.
	 */
	...
	*/
	public static final String MAXIMUM_NUMBER_OF_RETRIES = "maximum_retries_on_executor_failure";
}
