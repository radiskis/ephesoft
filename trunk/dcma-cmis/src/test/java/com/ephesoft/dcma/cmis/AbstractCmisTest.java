 ...
 */
@ContextConfiguration(locations = {"classpath:META-INF/applicationContext-cmis.xml"})
@Module("dcma-cmis")
public abstract class AbstractCmisTest extends DcmaTestCase {

	protected AbstractCmisTest() {
		super();
	}
}
