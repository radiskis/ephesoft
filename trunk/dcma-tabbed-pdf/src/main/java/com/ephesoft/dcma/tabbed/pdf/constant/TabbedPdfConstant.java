...
package com.ephesoft.dcma.tabbed.pdf.constant;
...
public interface TabbedPdfConstant {
	...
	public static final String GHOSTSCRIPT_COMMAND = "gswin32c.exe";
	public static String PDF_MARKS_FILE_NAME = "pdfmarks.dat";
	public static String PDF_MARKS_TEMPLATE = "[ /Page ## /Title (**) /OUT pdfmark";
