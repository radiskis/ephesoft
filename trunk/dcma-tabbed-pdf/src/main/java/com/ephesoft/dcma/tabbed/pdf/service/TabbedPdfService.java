 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.tabbed.pdf.service.TabbedPdfServiceImpl
 */
public interface TabbedPdfService {
	 ...
	 */
	void tabbedPdfExporter(final BatchInstanceID batchInstanceID, final String pluginWorkflow) throws DCMAException;
}
