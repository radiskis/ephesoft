 ...
 * 
 */
@ContextConfiguration(locations = {"classpath:META-INF/applicationContext-filebound.xml" })
@Module("dcma-filebound")
public abstract class AbstractFileboundTest extends DcmaTestCase {

	protected AbstractFileboundTest() {
		super();
	}
