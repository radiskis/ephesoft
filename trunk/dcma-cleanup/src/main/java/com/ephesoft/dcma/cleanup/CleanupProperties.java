 ...
 */
public enum CleanupProperties implements PluginProperty {
	/**
	 * Delete system information property.
	 */
	DELETE_SYSTEM_INFORMATION_PROPERTY("cleanup.delete_system_folder_info");
	...
	CleanupProperties(final String key) {
		this.key = key;
	}
	/**
