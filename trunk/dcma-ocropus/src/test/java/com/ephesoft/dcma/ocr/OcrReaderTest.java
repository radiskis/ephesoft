...
import com.ephesoft.dcma.ocr.service.OcrService;
...
public class OcrReaderTest extends AbstractOcrTests {
	 ...
	 */
	private String batchInstanceIdSuccess;
	/**
	...
	public void setup() {
		...
		actualOutputFolder = prop.getProperty(ACTUAL_OUTPUT_FOLDER);
		expectedOutputFolder = prop.getProperty(EXPECTED_OUTPUT_FOLDER);
		samplesFolder = prop.getProperty(SAMPLES_FOLDER);
	}
