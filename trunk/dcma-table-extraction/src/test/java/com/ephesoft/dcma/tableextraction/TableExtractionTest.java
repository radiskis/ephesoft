...
/**
 * This is Junit test for TableExtractionService. It contains two scenarios: one is a positive test case when HOCR xml file for batch
 * is present and second is a negative test case when HOCR xml file is not present.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.tableextraction.AbstractTableExtractionTest
 * 
 */
public class TableExtractionTest extends AbstractTableExtractionTest {

	/**
	 * String constants.
	 */
	private static final String PROP_FILE_TABLE_EXTRACTION_TEST = "test.properties";
	/**
	 * String constants.
	 */
	...
	/**
	 * Instance of TableExtractionService.
	 */
	@Autowired
	private transient TableExtractionService tableExtractionService;
	/**
	...
	public void setUp() throws IOException {
		...
		try {
			prop.load(TableExtractionTest.class.getClassLoader().getResourceAsStream(PROP_FILE_TABLE_EXTRACTION_TEST));
		} catch (IOException e) {
	...
	/**
	 * This is a test scenario in which hocr xml file is present and table extraction is executed successfully.
	 */
	@Test
	public void testTableExtractionSuccess() {
		boolean result = false;
		...
		try {
			...
			tableExtractionService.extractTableDocumentFields(new BatchInstanceID(batchInstanceIdSuccess), null);
	...
	/**
	 * This is a test scenario in which hocr xml file is not present and table extraction is not executed successfully.
	 */
	@Test
	public void testTableExtractionFailure() {
		boolean result = true;
		boolean created = false;
		BatchClass initialBatchClass = new BatchClass();
		try {
			...
			tableExtractionService.extractTableDocumentFields(new BatchInstanceID(batchInstanceIdFailure), null);
