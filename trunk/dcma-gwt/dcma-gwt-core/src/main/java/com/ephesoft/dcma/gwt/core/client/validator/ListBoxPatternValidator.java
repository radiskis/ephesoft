...
public class ListBoxPatternValidator implements Validator {
	...
	public ListBoxPatternValidator(ListBox listBox, List<String> patternStr) {
	...
	public boolean validate() {
		String inputStr = listBox.getValue(listBox.getSelectedIndex());
		...
		for (String patternString : patternStr) {
			allPatternMatched = allPatternMatched || (matchPattern(inputStr, patternString));
		}
