...
class NavBar extends Composite {
	...
	public NavBar() {
		...
		newerButton.setTitle("Previous");
		olderButton.setTitle("Next");
	}
	...
	public void update(int startIndex, int count, int max) {
		...
		if (listner != null) {
			countString = "Displaying " + (startIndex + 1) + " - " + max + " of " + count;
		} else {
			countString = "Displaying " + (startIndex + 1) + " - " + count + " of " + count;
		}
		if (count == 0) {
			countString = "Displaying " + (startIndex) + " - " + count + " of " + count;
		}
