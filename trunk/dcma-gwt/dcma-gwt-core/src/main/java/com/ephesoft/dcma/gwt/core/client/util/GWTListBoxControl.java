...
public class GWTListBoxControl {
	...
	public static ListBox createGWTListControl(String type, String actualValue, final String fieldName,
			List<String> values) {
	...
	public static ListBox createGWTListControl(String type, String actualValue, List<String> values) {
		return createGWTListControl(type, actualValue, null, values);
	}
