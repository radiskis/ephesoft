...
public class ImportBatchClassSuperConfig implements IsSerializable {
	private List<String> uncFolderList;
	private Node uiConfigRoot;
	
	public List<String> getUncFolderList() {
		return uncFolderList;
	}
	
	public void setUncFolderList(List<String> uncFolderList) {
	...
	public ImportBatchClassSuperConfig() {
		super();
		this.uncFolderList = new ArrayList<String>();
		this.uiConfigRoot = new Node();
	}
	
	public ImportBatchClassSuperConfig(List<String> uncFolderList, Node uiConfigList) {
		super();
		this.uncFolderList = uncFolderList;
