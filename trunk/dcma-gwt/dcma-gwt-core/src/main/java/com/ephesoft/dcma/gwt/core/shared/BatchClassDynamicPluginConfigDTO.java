...
public class BatchClassDynamicPluginConfigDTO implements IsSerializable {
	...
	private BatchClassDynamicPluginConfigDTO parent;

	private Collection<BatchClassDynamicPluginConfigDTO> children;
	...
	public BatchClassDynamicPluginConfigDTO getParent() {
		return parent;
	}
	...
	public Collection<BatchClassDynamicPluginConfigDTO> getChildren() {
		return children;
	}
