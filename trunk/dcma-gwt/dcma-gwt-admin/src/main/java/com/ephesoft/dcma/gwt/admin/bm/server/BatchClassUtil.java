...
public class BatchClassUtil {
	...
	public static void addAutoGeneratedPageType(DocumentType documentType) {
		...
		pageType.setName(documentType.getName() + "_First_Page");
		pageType.setDescription(documentType.getName() + "_First_Page");
		documentType.addPageType(pageType);
		pageType = new PageType();
		pageType.setName(documentType.getName() + "_Middle_Page");
		pageType.setDescription(documentType.getName() + "_Middle_Page");
		documentType.addPageType(pageType);
		pageType = new PageType();
		pageType.setName(documentType.getName() + "_Last_Page");
		pageType.setDescription(documentType.getName() + "_Last_Page");
		documentType.addPageType(pageType);
	}
