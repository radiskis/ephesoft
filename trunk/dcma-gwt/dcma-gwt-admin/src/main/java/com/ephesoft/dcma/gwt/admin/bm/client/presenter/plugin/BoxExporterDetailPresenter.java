...
import com.ephesoft.dcma.gwt.admin.bm.client.view.plugin.BoxExporterDetailView;
...
/**
 * The presenter for box exporter details view.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.gwt.admin.bm.client.presenter.AbstractBatchClassPresenter
 */
public class BoxExporterDetailPresenter extends AbstractBatchClassPresenter<BoxExporterDetailView> {

	/**
	 * Constructor.
	 * 
	 * @param controller BatchClassManagementController
	 * @param view BoxExporterDetailView
	 */
	public BoxExporterDetailPresenter(BatchClassManagementController controller, BoxExporterDetailView view) {
