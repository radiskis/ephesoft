...
import com.ephesoft.dcma.gwt.admin.bm.client.view.cmisimporter.CmisImporterDetailView;
import com.google.gwt.event.shared.HandlerManager;

/**
 * The presenter for view that shows the cmis importer details.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.gwt.admin.bm.client.presenter.AbstractBatchClassPresenter
 */
public class CmisImporterDetailPresenter extends AbstractBatchClassPresenter<CmisImporterDetailView> {

	/**
	 * Constructor.
	 * 
	 * @param controller BatchClassManagementController
	 * @param view CmisImporterDetailView
	 */
	public CmisImporterDetailPresenter(BatchClassManagementController controller, CmisImporterDetailView view) {
