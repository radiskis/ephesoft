...
public class FolderManagementController extends AbstractController {
	...
	public void setFolderManagementView(FolderManagementView folderManagementView) {
		this.folderManagementView = folderManagementView;
	}
	...
	public void setFolderManagementPresenter(FolderManagementPresenter folderManagementPresenter) {
		this.folderManagementPresenter = folderManagementPresenter;
	}

	public FolderManagementController(HandlerManager eventBus, DCMARemoteServiceAsync rpcService) {
	...
	public Composite createView() {
		...
		this.folderManagementPresenter = new FolderManagementPresenter(this, this.folderManagementView);
		return this.folderManagementView;
	}

	@Override
	public void injectEvents(HandlerManager eventBus) {
		//no need to implement any events on the controller
	}

	@Override
	public void refresh() {
		//no need to implement refresh on the controller
	}
