...
public class ReportingController extends Controller {
	...
	private ReportingView view;

	public ReportingController(HandlerManager eventBus, ReportingModelServiceAsync rpcService) {
		super(eventBus, rpcService);
	}

	public ReportingPresenter getPresenter() {
	...
	@Override
	public ReportingModelServiceAsync getRpcService() {
		return (ReportingModelServiceAsync) super.getRpcService();
	}
}
