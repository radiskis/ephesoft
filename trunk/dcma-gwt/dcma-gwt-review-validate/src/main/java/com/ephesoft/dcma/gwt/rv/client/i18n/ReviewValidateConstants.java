...
package com.ephesoft.dcma.gwt.rv.client.i18n;
...
public interface ReviewValidateConstants extends LocaleCommonConstants {
	...
	String INSERT_ROW_BUTTON = "insert_row_button";

	String DELETE_ROW_BUTTON = "delete_row_button";

	String ROW_SELECTION_STYLE = "row_selection_style";

	String OK_BUTTON = "ok_button";

	String CANCEL_BUTTON = "cancel_button";

	String TABLE_INSERT_ROW_SHORTCUT = "table_insert_row_shortcut";

	String TABLE_DELETE_ROW_SHORTCUT = "table_delete_row_shortcut";

	String TRAVERSE_TABLES_SHORTCUT = "traverse_table_shortcut";

	String ERROR_STYLE = "error_style";

	String IMAGE_SCROLL_LEFT_SHORTCUT = "image_scroll_left_shortcut";

	String IMAGE_SCROLL_RIGHT_SHORTCUT = "image_scroll_right_shortcut";

	String IMAGE_SCROLL_UP_SHORTCUT = "image_scroll_up_shortcut";

	String IMAGE_SCROLL_DOWN_SHORTCUT = "image_scroll_down_shortcut";

	String IMAGE_ZOOM_LOCK = "image_zoom_lock";

	String ZOOM_LOCKED = "zoom_locked";

	String ZOOM_UNLOCKED = "zoom_unlocked";

	String DOC_TYPE_TOGGLE = "doc_type_toggle";

	String DROPBOX_STYLE = "dropdownBox";

	String NEXT_DOC_TYPE = "next_doc_type";

	String PREV_DOC_TYPE = "prev_doc_type";

	String NEXT_PAGE_TYPE = "next_page_type";

	String PREV_PAGE_TYPE = "prev_page_type";

	String INPUTBOX_STYLE = "validatePanelListBox";

	String UNABLE_TO_FOUND = "unable_to_found";

	String SCRIPT_EXECUTION = "script_execution";

	String OVERFLOW_SCROLL = "overflow_scroll";

	String DELETE_ALL_ROW_BUTTON = "delete_all_row_button";

	String ADD_NEW_TABLE_BUTTON = "add_new_table_button";

	String ADD_NEW_TABLE_SHORTCUT = "add_new_table";

	String FUNCTION_KEYS = "Function Keys";

	String BOLD_TEXT = "bold_text";

	String TABLE_DELETE_ALL_ROW_SHORTCUT = "table_delete_all_row_shortcut";

	String ADD_NEW_TABLE_FAIL_TITLE = "add_new_table_fail_title";

	String MSG_NEXT_BATCH = "msg_next_batch";

	String MANUAL_EXTRACTION = "manual_extraction";

	String START_EXTRACTION = "start_extraction";

	String ADD_NEW_TABLE_TITLE = "add_new_table";

	int ROW_ERROR_MARGIN = 50;

	String MANUAL_TABLE_EXTRACTION_SHORTCUT = "manual_table_extraction_shortcut";

	String APP_CTRL_4 = "name_of_app_shortcut_ctrl_4";

	String APP_CTRL_7 = "name_of_app_shortcut_ctrl_7";

	String APP_CTRL_8 = "name_of_app_shortcut_ctrl_8";
