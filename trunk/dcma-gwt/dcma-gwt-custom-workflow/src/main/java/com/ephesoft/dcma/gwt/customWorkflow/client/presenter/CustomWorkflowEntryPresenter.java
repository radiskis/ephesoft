...
public class CustomWorkflowEntryPresenter extends AbstractCustomWorkflowPresenter<CustomWorkflowEntryView> {
	...
	private final ViewAndAddPluginsPresenter viewAndAddPluginsPresenter;

	public CustomWorkflowEntryPresenter(CustomWorkflowController customWorkflowController,
	...
	/**
	 * @return the viewAndAddPluginsPresenter
	 */
