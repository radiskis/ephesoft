...
public class AllPluginsListPresenter extends AbstractCustomWorkflowPresenter<AllPluginsListView>{

	public AllPluginsListPresenter(CustomWorkflowController controller, AllPluginsListView view) {
