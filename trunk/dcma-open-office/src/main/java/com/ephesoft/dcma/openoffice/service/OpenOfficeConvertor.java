...
public class OpenOfficeConvertor implements SmartLifecycle, FileFormatConvertor {
	...
	private static String _LOCK_FILE = "_lock";
	...
	@Override
	public void convert(String inputFilePath, String outputFilePath, FileType outputFileType) {
		File outFile = new File(outputFilePath);
		outFile.getParentFile().mkdirs();
		outputFilePath = new File(getAbsoluteLocation() + File.separator + outFile.getParentFile().getName() + File.separator
		...
		File tempFile = new File(getSharedLocation() + File.separator + outFile.getParentFile().getName() + File.separator
				+ outFile.getName());
		jodConverter.convert(inputFilePath, outputFilePath, new DefaultDocumentFormatRegistry().getFormatByExtension(outputFileType
				.getExtension()));
		try {
