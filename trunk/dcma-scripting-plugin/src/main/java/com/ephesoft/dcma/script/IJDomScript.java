...
/**
 * The <code>IJDomScript</code> interface represents the script execute structure. Writer of scripts plug-in should implement this
 * IJDomScript interface to execute it from the scripting plug-in. Via implementing this interface writer can change its java file at
...
public interface IJDomScript {
	 ...
	 * @return Object
	 */
	Object execute(Document document, String methodName, String docIdentifier);
