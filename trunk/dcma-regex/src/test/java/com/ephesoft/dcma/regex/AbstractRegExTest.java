 ...
 * 
 */
@ContextConfiguration(locations = {"classpath:META-INF/applicationContext-regex.xml" })
@Module("dcma-regex")
public abstract class AbstractRegExTest extends DcmaTestCase {

	protected AbstractRegExTest() {
		super();
	}
