...
public class SearchClassification implements DocumentClassification {
	...
	public final void processUnclassifiedPages(final DocumentAssembler documentAssembler, final String batchInstanceIdentifier,
		...
		String ruleFMLPage = pluginPropertiesService.getPropertyValue( batchInstanceIdentifier, DocumentAssemblerConstants.DOCUMENT_ASSEMBLER_PLUGIN,
				DocumentAssemblerProperties.DA_RULE_FP_MP_LP);
		String ruleFPage = pluginPropertiesService.getPropertyValue( batchInstanceIdentifier, DocumentAssemblerConstants.DOCUMENT_ASSEMBLER_PLUGIN,
				DocumentAssemblerProperties.DA_RULE_FP);
		String ruleMPage = pluginPropertiesService.getPropertyValue( batchInstanceIdentifier, DocumentAssemblerConstants.DOCUMENT_ASSEMBLER_PLUGIN,
				DocumentAssemblerProperties.DA_RULE_MP);
		String ruleLPage = pluginPropertiesService.getPropertyValue( batchInstanceIdentifier, DocumentAssemblerConstants.DOCUMENT_ASSEMBLER_PLUGIN,
				DocumentAssemblerProperties.DA_RULE_LP);
		String ruleFLPage = pluginPropertiesService.getPropertyValue( batchInstanceIdentifier, DocumentAssemblerConstants.DOCUMENT_ASSEMBLER_PLUGIN,
				DocumentAssemblerProperties.DA_RULE_FP_LP);
		String ruleMLPage = pluginPropertiesService.getPropertyValue( batchInstanceIdentifier, DocumentAssemblerConstants.DOCUMENT_ASSEMBLER_PLUGIN,
				DocumentAssemblerProperties.DA_RULE_MP_LP);
		String ruleFMPage = pluginPropertiesService.getPropertyValue( batchInstanceIdentifier, DocumentAssemblerConstants.DOCUMENT_ASSEMBLER_PLUGIN,
