 ...
 * 
 */
@ContextConfiguration(locations = { "classpath:META-INF/applicationContext-barcode.xml" })
@Module("dcma-barcode")
public abstract class AbstractBarcodeTests extends DcmaTestCase {

	protected AbstractBarcodeTests() {
		super();
