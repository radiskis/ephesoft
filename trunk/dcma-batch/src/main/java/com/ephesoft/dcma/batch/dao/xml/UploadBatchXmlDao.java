...
/**
 * XmlDao for upload batch info xml .
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.batch.schema.UploadBatchMetaData
 */
@Repository
public class UploadBatchXmlDao extends XmlDao<UploadBatchMetaData> {
