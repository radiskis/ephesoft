...
import com.ephesoft.dcma.mail.dao.EmailQueueDao;
import com.ephesoft.dcma.mail.domain.EmailData;

/**
 * A Service implementing a generic, simple email queue.
 */
public class MailQueueServiceImpl implements MailQueueService {
	...
	private void sendEmail(final EmailData emailData) {
		...
		metaData.setFromAddress(emailData.getSender());
