 ...
 * <p>
 * OpenOffice.org supports two connection types: TCP sockets and named pipes. Named pipes are marginally faster and do not take up a
 * TCP port, but they require native libraries, which means setting <em>java.library.path</em> when starting Java. E.g. on Linux
 * 
 * <pre>
...
class UnoUrl {
	...
	public static UnoUrl socket(String host, int port) {
		...
		String socketString = "uno:socket,host=" + host + "," + "port=" + port;
