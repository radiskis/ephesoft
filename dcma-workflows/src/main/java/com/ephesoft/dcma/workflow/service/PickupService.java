...
/**
 * This class is used to initializing the Pickup services. It is used to pick up the batch instances.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.workflow.service.PickupServiceImpl
 * 
 */
